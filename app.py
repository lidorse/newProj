...
Home_page_button = '<p></p><button><a href="http://172.20.0.2:5000/">Home Page</a></button>'
account_page_button = '<p></p><button><a href="http://172.20.0.2:5000/accountActions">Back to Account page</a></button>'
...
def storeUser():
    ...
    return f'{fullName} has been added successfully!' + Home_page_button + '<p></p><button><a href="http://172.20.0.2:5000/accountActions">Go to Account page</a></button>'
